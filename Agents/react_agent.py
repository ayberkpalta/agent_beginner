...
4. Test out robutness of your graph
...
Sequence - To automatically handle the state updates for sequences such as by adding new mesages to a chat history
...
@tool
def add(a: int, b: int):
    """This is an addition function -> add 2 numbers """ #necessary
    return a + b
...
def model_call(state:AgentState)->AgentState:
    system_prompt=SystemMessage(content=
                "You are my AI asistant, please answer my query to the best of your ability"
    )
